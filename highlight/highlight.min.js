...
end:"$",illegal:"\n"},o]}}})();hljs.registerLanguage("kotlin",e)})();/*! `perl` grammar compiled for Highlight.js 11.5.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
contains:d}}})();hljs.registerLanguage("perl",e)})();/*! `java` grammar compiled for Highlight.js 11.5.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("ruby",e)})();/*! `haskell` grammar compiled for Highlight.js 11.5.0 */
...
}),n,{begin:"->|<-"}]}}})();hljs.registerLanguage("haskell",e)})();/*! `rust` grammar compiled for Highlight.js 11.5.0 */
...
;hljs.registerLanguage("plaintext",t)})();/*! `bash` grammar compiled for Highlight.js 11.5.0 */
...
;hljs.registerLanguage("bash",e)})();/*! `javascript` grammar compiled for Highlight.js 11.5.0 */
(()=>{var e=(()=>{"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],t=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],s=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],r=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],c=["arguments","this","super","console","window","document","localStorage","module","global"],i=[].concat(r,t,s)
...
relevance:0}]}}})();hljs.registerLanguage("objectivec",e)})();/*! `sql` grammar compiled for Highlight.js 11.5.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `css` grammar compiled for Highlight.js 11.5.0 */
(()=>{var e=(()=>{"use strict"
